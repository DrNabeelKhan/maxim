...
**Kiro layout:** planning files live under **`.kiro/plan/`** (not the project root). See [Kiro Steering — file references](https://kiro.dev/documents/steering/) for `#[[file:path]]` live includes.
