...
show_wizard() {
  ...
  echo "  • 64 behavioral frameworks active by default"
  echo "  • 14 compliance frameworks enforced at MCP layer"
  echo "  • 9 MCPs · 87 tools including NotebookLM research synthesis"
  echo ""
...
do_solo() {
  ...
  echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo ""
  echo "Maxim Core is fully active. 64 behavioral frameworks dispatch on"
