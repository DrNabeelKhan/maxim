...
## Purpose
Apply E-E-A-T to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `e-e-a-t` |
| Category | Search Visibility |
| Version | 1.0.0 |
| Owner | Google Search Quality |
| Maturity | Established (2014, updated 2022) |
| Primary References | Experience, Expertise, Authoritativeness, Trustworthiness |

## Prompt Template
```
You are applying the E-E-A-T framework.
...
1. **Identify**: What aspect of E-E-A-T applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with E-E-A-T principles
...
## Core Principles
- **Foundation**: E-E-A-T provides structured approach to search visibility
...
|----------|-------------|----------------|
| Strategic Planning | Apply E-E-A-T to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Experience, Expertise, Authoritativeness, Trustworthiness](https://developers.google.com/search/documents/fundamentals/creating-helpful-content) - Google Search Quality
...
## Testing Strategy
- Validate that recommendations clearly map back to E-E-A-T principles
