...
frameworks: []
triggers:
  - apply content calendar
  - use content-calendar framework
...
## Purpose
Apply Content Calendar to craft compelling messages, understand customer journeys, and drive ethical engagement.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `content-calendar` |
| Category | Content Marketing |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established |
| Primary References | Editorial Planning Framework |

## Prompt Template
```
You are applying the Content Calendar framework.
...
1. **Identify**: What aspect of Content Calendar applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Content Calendar principles
...
## Core Principles
- **Foundation**: Content Calendar provides structured approach to content marketing
...
|----------|-------------|----------------|
| Strategic Planning | Apply Content Calendar to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Editorial Planning Framework](Industry standard) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to Content Calendar principles
