...
## Purpose
Apply TAM/SAM/SOM to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `tamsamsom` |
| Category | Product Research |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established |
| Primary References | Market Sizing Framework |

## Prompt Template
```
You are applying the TAM/SAM/SOM framework.
...
1. **Identify**: What aspect of TAM/SAM/SOM applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with TAM/SAM/SOM principles
...
## Core Principles
- **Foundation**: TAM/SAM/SOM provides structured approach to product research
...
|----------|-------------|----------------|
| Strategic Planning | Apply TAM/SAM/SOM to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Market Sizing Framework](Industry standard) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to TAM/SAM/SOM principles
