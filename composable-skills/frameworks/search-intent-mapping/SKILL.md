---
skill_id: search-intent-mapping
...
triggers:
  ...
  - use search-intent-mapping framework
  - search intent mapping analysis
collaborates_with:
...
## Purpose
Apply Search Intent Mapping to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `search-intent-mapping` |
| Category | Search Visibility |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established |
| Primary References | Search Intent Classification |

## Prompt Template
```
You are applying the Search Intent Mapping framework.
...
1. **Identify**: What aspect of Search Intent Mapping applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Search Intent Mapping principles
...
## Core Principles
- **Foundation**: Search Intent Mapping provides structured approach to search visibility
...
|----------|-------------|----------------|
| Strategic Planning | Apply Search Intent Mapping to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Search Intent Classification](https://moz.com/learn/seo/search-intent) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to Search Intent Mapping principles
