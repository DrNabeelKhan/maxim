...
## Purpose
Apply MITRE ATT&CK to identify, assess, and mitigate security risks in systems, processes, and data handling.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `mitre-attck` |
| Category | Security |
| Version | 1.0.0 |
| Owner | MITRE Corporation |
| Maturity | Established (2015) |
| Primary References | Adversary Tactics and Techniques |

## Prompt Template
```
You are applying the MITRE ATT&CK framework.
...
1. **Identify**: What aspect of MITRE ATT&CK applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with MITRE ATT&CK principles
...
## Core Principles
- **Foundation**: MITRE ATT&CK provides structured approach to security
...
|----------|-------------|----------------|
| Strategic Planning | Apply MITRE ATT&CK to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Adversary Tactics and Techniques](https://attack.mitre.org/) - MITRE Corporation
...
## Testing Strategy
- Validate that recommendations clearly map back to MITRE ATT&CK principles
