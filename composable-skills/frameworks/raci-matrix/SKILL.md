...
## Purpose
Apply RACI Matrix to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `raci-matrix` |
| Category | Project Management |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established |
| Primary References | Responsibility Assignment Matrix |

## Prompt Template
```
You are applying the RACI Matrix framework.
...
1. **Identify**: What aspect of RACI Matrix applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with RACI Matrix principles
...
## Core Principles
- **Foundation**: RACI Matrix provides structured approach to project management
...
|----------|-------------|----------------|
| Strategic Planning | Apply RACI Matrix to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Responsibility Assignment Matrix](Industry standard) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to RACI Matrix principles
