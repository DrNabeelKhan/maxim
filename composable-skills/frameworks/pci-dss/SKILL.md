...
## Purpose
Apply PCI-DSS to identify, assess, and mitigate security risks in systems, processes, and data handling.
...
| Maturity | Established (2004, updated 2022) |
| Primary References | Payment Card Industry Data Security Standard |

## Prompt Template
```
You are applying the PCI-DSS framework.
...
1. **Identify**: What aspect of PCI-DSS applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with PCI-DSS principles
...
## Core Principles
- **Foundation**: PCI-DSS provides structured approach to security
...
|----------|-------------|----------------|
| Strategic Planning | Apply PCI-DSS to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Payment Card Industry Data Security Standard](https://www.pcisecuritystandards.org/) - PCI Security Standards Council
...
## Testing Strategy
- Validate that recommendations clearly map back to PCI-DSS principles
