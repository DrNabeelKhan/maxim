...
## Purpose
Apply ISO 27001 to identify, assess, and mitigate security risks in systems, processes, and data handling.
...
| Version | 1.0.0 |
| Owner | ISO/IEC |
| Maturity | Established (2005, updated 2022) |
| Primary References | Information Security Management System |

## Prompt Template
```
You are applying the ISO 27001 framework.
...
1. **Identify**: What aspect of ISO 27001 applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with ISO 27001 principles
...
## Core Principles
- **Foundation**: ISO 27001 provides structured approach to security
...
|----------|-------------|----------------|
| Strategic Planning | Apply ISO 27001 to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Information Security Management System](https://www.iso.org/standard/27001) - ISO/IEC
...
## Testing Strategy
- Validate that recommendations clearly map back to ISO 27001 principles
