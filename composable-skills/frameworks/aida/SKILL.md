...
## Purpose
Apply AIDA to craft compelling messages, understand customer journeys, and drive ethical engagement.
...
| Category | Content Marketing |
| Version | 1.0.0 |
| Owner | E. St. Elmo Lewis |
| Maturity | Established (1898) |
| Primary References | Attention, Interest, Desire, Action |

## Prompt Template
```
You are applying the AIDA framework.
...
1. **Identify**: What aspect of AIDA applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with AIDA principles
...
## Core Principles
- **Foundation**: AIDA provides structured approach to content marketing
...
|----------|-------------|----------------|
| Strategic Planning | Apply AIDA to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Attention, Interest, Desire, Action](Industry standard) - E. St. Elmo Lewis
...
## Testing Strategy
- Validate that recommendations clearly map back to AIDA principles
