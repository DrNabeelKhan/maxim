---
skill_id: zero-trust-architecture
...
triggers:
  ...
  - use zero-trust-architecture framework
...
## Purpose
Apply Zero Trust Architecture to identify, assess, and mitigate security risks in systems, processes, and data handling.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `zero-trust-architecture` |
| Category | Security |
| Version | 1.0.0 |
| Owner | NIST / Industry Standard |
| Maturity | Established (2020) |
| Primary References | Zero Trust Security Model |

## Prompt Template
```
You are applying the Zero Trust Architecture framework.
...
1. **Identify**: What aspect of Zero Trust Architecture applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Zero Trust Architecture principles
...
## Core Principles
- **Foundation**: Zero Trust Architecture provides structured approach to security
...
|----------|-------------|----------------|
| Strategic Planning | Apply Zero Trust Architecture to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Zero Trust Security Model](https://csrc.nist.gov/publications/detail/sp/800-207/final) - NIST / Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to Zero Trust Architecture principles
