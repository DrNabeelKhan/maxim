...
triggers:
  ...
  - use cognitive-biases framework
...
## Purpose
Apply Cognitive Biases to understand and influence human behavior in product design, marketing, and user experience.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `cognitive-biases` |
| Category | Behavior Science |
| Version | 1.0.0 |
| Owner | Kahneman & Tversky |
| Maturity | Established (1970s) |
| Primary References | Systematic Thinking Errors |

## Prompt Template
```
You are applying the Cognitive Biases framework.
...
1. **Identify**: What aspect of Cognitive Biases applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Cognitive Biases principles
...
## Core Principles
- **Foundation**: Cognitive Biases provides structured approach to behavior science
...
|----------|-------------|----------------|
| Strategic Planning | Apply Cognitive Biases to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Systematic Thinking Errors](https://www.nngroup.com/articles/cognitive-biases/) - Kahneman & Tversky
...
## Testing Strategy
- Validate that recommendations clearly map back to Cognitive Biases principles
