...
## Purpose
Apply ITIL to design scalable, maintainable, and interoperable enterprise systems and solutions.
...
| Primary References | Information Technology Infrastructure Library |

## Prompt Template
```
You are applying the ITIL framework.
...
1. **Identify**: What aspect of ITIL applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with ITIL principles
...
## Core Principles
- **Foundation**: ITIL provides structured approach to enterprise architecture
...
|----------|-------------|----------------|
| Strategic Planning | Apply ITIL to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Information Technology Infrastructure Library](https://www.axelos.com/certifications/itil-service-management) - Axelos
...
## Testing Strategy
- Validate that recommendations clearly map back to ITIL principles
