...
## Purpose
Apply DevSecOps to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `devsecops` |
| Category | Engineering Devops |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established (2010s) |
| Primary References | Development, Security, Operations |

## Prompt Template
```
You are applying the DevSecOps framework.
...
1. **Identify**: What aspect of DevSecOps applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with DevSecOps principles
...
## Core Principles
- **Foundation**: DevSecOps provides structured approach to engineering devops
...
|----------|-------------|----------------|
| Strategic Planning | Apply DevSecOps to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Development, Security, Operations](Industry standard) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to DevSecOps principles
