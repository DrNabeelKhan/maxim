...
frameworks: []
triggers:
  - apply user journey mapping
  - use user-journey-mapping framework
...
## Purpose
Apply User Journey Mapping to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `user-journey-mapping` |
| Category | Design Ux |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established |
| Primary References | Customer Experience Visualization |

## Prompt Template
```
You are applying the User Journey Mapping framework.
...
1. **Identify**: What aspect of User Journey Mapping applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with User Journey Mapping principles
...
## Core Principles
- **Foundation**: User Journey Mapping provides structured approach to design ux
...
|----------|-------------|----------------|
| Strategic Planning | Apply User Journey Mapping to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Customer Experience Visualization](Industry standard) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to User Journey Mapping principles
