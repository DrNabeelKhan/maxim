---
skill_id: nist-cybersecurity-framework
...
triggers:
  ...
  - use nist-cybersecurity-framework framework
...
## Purpose
Apply NIST Cybersecurity Framework to identify, assess, and mitigate security risks in systems, processes, and data handling.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `nist-cybersecurity-framework` |
| Category | Security |
| Version | 1.0.0 |
| Owner | NIST (National Institute of Standards and Technology) |
| Maturity | Established (2014, updated 2018) |
| Primary References | NIST CSF |

## Prompt Template
```
You are applying the NIST Cybersecurity Framework framework.
...
1. **Identify**: What aspect of NIST Cybersecurity Framework applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with NIST Cybersecurity Framework principles
...
## Core Principles
- **Foundation**: NIST Cybersecurity Framework provides structured approach to security
...
|----------|-------------|----------------|
| Strategic Planning | Apply NIST Cybersecurity Framework to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [NIST CSF](https://www.nist.gov/cyberframework) - NIST (National Institute of Standards and Technology)
...
## Testing Strategy
- Validate that recommendations clearly map back to NIST Cybersecurity Framework principles
