---
skill_id: microservices-architecture
...
triggers:
  ...
  - use microservices-architecture framework
...
## Purpose
Apply Microservices Architecture to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `microservices-architecture` |
| Category | Engineering Devops |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established (2010s) |
| Primary References | Service-Oriented Architecture |

## Prompt Template
```
You are applying the Microservices Architecture framework.
...
1. **Identify**: What aspect of Microservices Architecture applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Microservices Architecture principles
...
## Core Principles
- **Foundation**: Microservices Architecture provides structured approach to engineering devops
...
|----------|-------------|----------------|
| Strategic Planning | Apply Microservices Architecture to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Service-Oriented Architecture](Industry standard) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to Microservices Architecture principles
