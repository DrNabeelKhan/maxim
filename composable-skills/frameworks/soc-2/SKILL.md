...
## Purpose
Apply SOC 2 to identify, assess, and mitigate security risks in systems, processes, and data handling.
...
| Primary References | Service Organization Control 2 |

## Prompt Template
```
You are applying the SOC 2 framework.
...
1. **Identify**: What aspect of SOC 2 applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with SOC 2 principles
...
## Core Principles
- **Foundation**: SOC 2 provides structured approach to security
...
|----------|-------------|----------------|
| Strategic Planning | Apply SOC 2 to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Service Organization Control 2](https://www.aicpa.org/) - AICPA
...
## Testing Strategy
- Validate that recommendations clearly map back to SOC 2 principles
