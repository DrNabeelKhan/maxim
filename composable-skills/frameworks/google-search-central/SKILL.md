---
skill_id: google-search-central
...
frameworks: []
triggers:
  - apply google search central
  - use google-search-central framework
  - google search central analysis
collaborates_with:
  - seo-specialist
...
priority: medium
tags: [search-visibility, framework]
created: 2026-03-14
updated: 2026-03-14
---
...
## Purpose
Apply Google Search Central to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `google-search-central` |
| Category | Search Visibility |
| Version | 1.0.0 |
| Owner | Google |
| Maturity | Established (1998) |
| Primary References | Google Search Guidelines |

## Prompt Template
```
You are applying the Google Search Central framework.
...
1. **Identify**: What aspect of Google Search Central applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Google Search Central principles
...
## Core Principles
- **Foundation**: Google Search Central provides structured approach to search visibility
- **Application**: Use when facing decisions requiring search visibility guidance
...
|----------|-------------|----------------|
| Strategic Planning | Apply Google Search Central to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Google Search Guidelines](https://developers.google.com/search) - Google
...
## Testing Strategy
- Validate that recommendations clearly map back to Google Search Central principles
