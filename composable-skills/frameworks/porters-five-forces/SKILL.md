...
triggers:
  ...
  - use porters-five-forces framework
...
## Purpose
Apply Porter's Five Forces to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `porters-five-forces` |
| Category | Product Research |
| Version | 1.0.0 |
| Owner | Michael Porter (Harvard Business School) |
| Maturity | Established (1979) |
| Primary References | Industry Competition Analysis |

## Prompt Template
```
You are applying the Porter's Five Forces framework.
...
1. **Identify**: What aspect of Porter's Five Forces applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Porter's Five Forces principles
...
## Core Principles
- **Foundation**: Porter's Five Forces provides structured approach to product research
...
|----------|-------------|----------------|
| Strategic Planning | Apply Porter's Five Forces to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Industry Competition Analysis](HBR Publications) - Michael Porter (Harvard Business School)
...
## Testing Strategy
- Validate that recommendations clearly map back to Porter's Five Forces principles
