...
triggers:
  ...
  - use nielsen-heuristics framework
...
## Purpose
Apply Nielsen Heuristics to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `nielsen-heuristics` |
| Category | Product Research |
| Version | 1.0.0 |
| Owner | Jakob Nielsen |
| Maturity | Established (1994) |
| Primary References | 10 Usability Heuristics |

## Prompt Template
```
You are applying the Nielsen Heuristics framework.
...
1. **Identify**: What aspect of Nielsen Heuristics applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Nielsen Heuristics principles
...
## Core Principles
- **Foundation**: Nielsen Heuristics provides structured approach to product research
...
|----------|-------------|----------------|
| Strategic Planning | Apply Nielsen Heuristics to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [10 Usability Heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) - Jakob Nielsen
...
## Testing Strategy
- Validate that recommendations clearly map back to Nielsen Heuristics principles
