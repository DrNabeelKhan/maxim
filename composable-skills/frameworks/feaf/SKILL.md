...
## Purpose
Apply FEAF to design scalable, maintainable, and interoperable enterprise systems and solutions.
...
| Primary References | Federal Enterprise Architecture Framework |

## Prompt Template
```
You are applying the FEAF framework.
...
1. **Identify**: What aspect of FEAF applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with FEAF principles
...
## Core Principles
- **Foundation**: FEAF provides structured approach to enterprise architecture
...
|----------|-------------|----------------|
| Strategic Planning | Apply FEAF to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Federal Enterprise Architecture Framework](https://enterprisearchitecture.gov/) - U.S. Federal CIO Council
...
## Testing Strategy
- Validate that recommendations clearly map back to FEAF principles
