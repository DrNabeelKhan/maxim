...
## Purpose
Apply Hook Model to understand and influence human behavior in product design, marketing, and user experience.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `hook-model` |
| Category | Behavior Science |
| Version | 1.0.0 |
| Owner | Nir Eyal |
| Maturity | Established (2014) |
| Primary References | Trigger-Action-Reward-Investment |

## Prompt Template
```
You are applying the Hook Model framework.
...
1. **Identify**: What aspect of Hook Model applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Hook Model principles
...
## Core Principles
- **Foundation**: Hook Model provides structured approach to behavior science
...
|----------|-------------|----------------|
| Strategic Planning | Apply Hook Model to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Trigger-Action-Reward-Investment](https://www.nirandfar.com/hooked/) - Nir Eyal
...
## Testing Strategy
- Validate that recommendations clearly map back to Hook Model principles
