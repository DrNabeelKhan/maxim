...
## Purpose
Apply DMBOK to design scalable, maintainable, and interoperable enterprise systems and solutions.
...
| Primary References | Data Management Body of Knowledge |

## Prompt Template
```
You are applying the DMBOK framework.
...
1. **Identify**: What aspect of DMBOK applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with DMBOK principles
...
## Core Principles
- **Foundation**: DMBOK provides structured approach to enterprise architecture
...
|----------|-------------|----------------|
| Strategic Planning | Apply DMBOK to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Data Management Body of Knowledge](https://www.dama.org/) - DAMA International
...
## Testing Strategy
- Validate that recommendations clearly map back to DMBOK principles
