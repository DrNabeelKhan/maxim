...
## Purpose
Apply BIZBOK to design scalable, maintainable, and interoperable enterprise systems and solutions.
...
| Primary References | Business Architecture Body of Knowledge |

## Prompt Template
```
You are applying the BIZBOK framework.
...
1. **Identify**: What aspect of BIZBOK applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with BIZBOK principles
...
## Core Principles
- **Foundation**: BIZBOK provides structured approach to enterprise architecture
...
|----------|-------------|----------------|
| Strategic Planning | Apply BIZBOK to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Business Architecture Body of Knowledge](https://www.businessarchitectureguild.org/) - Business Architecture Guild
...
## Testing Strategy
- Validate that recommendations clearly map back to BIZBOK principles
