...
frameworks: []
triggers:
  - apply east framework
  - use east-framework framework
...
## Purpose
Apply EAST Framework to understand and influence human behavior in product design, marketing, and user experience.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `east-framework` |
| Category | Behavior Science |
| Version | 1.0.0 |
| Owner | Behavioural Insights Team (BIT) |
| Maturity | Established (2014) |
| Primary References | Easy, Attractive, Social, Timely |

## Prompt Template
```
You are applying the EAST Framework framework.
...
1. **Identify**: What aspect of EAST Framework applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with EAST Framework principles
...
## Core Principles
- **Foundation**: EAST Framework provides structured approach to behavior science
...
|----------|-------------|----------------|
| Strategic Planning | Apply EAST Framework to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Easy, Attractive, Social, Timely](https://www.bi.team/publications/) - Behavioural Insights Team (BIT)
...
## Testing Strategy
- Validate that recommendations clearly map back to EAST Framework principles
