...
## Purpose
Apply Design Systems to guide decision-making, structure analysis, and improve outcomes in relevant contexts.

## Frameworks & Standards
| Item | Value |
|------|-------|
| Framework ID | `design-systems` |
| Category | Design Ux |
| Version | 1.0.0 |
| Owner | Industry Standard |
| Maturity | Established (2010s) |
| Primary References | Reusable Design Component Library |

## Prompt Template
```
You are applying the Design Systems framework.
...
1. **Identify**: What aspect of Design Systems applies to this situation?
...
QUALITY CHECKS:
□ All recommendations align with Design Systems principles
...
## Core Principles
- **Foundation**: Design Systems provides structured approach to design ux
...
|----------|-------------|----------------|
| Strategic Planning | Apply Design Systems to structure analysis | Clearer priorities and rationale |
...
## Reference Materials
- [Reusable Design Component Library](Material Design, Carbon, etc.) - Industry Standard
...
## Testing Strategy
- Validate that recommendations clearly map back to Design Systems principles
