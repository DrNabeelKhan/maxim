...
| **Pro Trial** | $0, 90 days auto-activated on install | Activation bridge — Starter + full 10 watch classes + 50 behavioral_audit/mo + 14 compliance frameworks (GDPR, SOC2, PIPEDA) + MemPalace semantic + ADR-010 rubric + 10 min/day voice + 20 brand overlays/mo. |
| **Solo (MOAT anchor)** | **$19.99/mo** | The behavioral intelligence specialist. Unlimited behavioral_audit, all 74 behavioral frameworks, nudge design, persuasion tools, TTM stage detection. No compliance depth, no brand/design tools, no team features, no overlays. |
