...
**Current canonical counts** (v1.3.2): 91 specialist agents (24 dispatchable + 67 specialist catalog via mxm-catalog MCP per ADR-017) · 52 skill domains · 50 slash commands · 9 MCP servers / 95 tools (incl. mxm-notebooklm 38-tool research synthesis per ADR-018) · 16 hook scripts · 78 behavioral frameworks · 14 compliance frameworks · 22 ADRs · 13 Proactive Watch drift classes · 90-day Trial of all 14 packs default at install (ADR-019)
...
When the user types any of the 50 slash commands below, treat the text as a routing directive — execute the mapped behavior immediately. Don't ask "did you mean to type a command?" — just route.
...
- Counts current (91 agents · 52 skills · 50 commands · 78 frameworks · 13 drift classes)
