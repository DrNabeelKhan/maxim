...
| **Pack(s)** | Free tier (architecture-level moat). Every paid pack benefits — Pack 6 Behavioral Intelligence in particular, because specialist routing is what makes the 74 frameworks dispatchable per task. |
