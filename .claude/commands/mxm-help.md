...
Claude Code into a multi-office operator team with structural enforcement of:
  ...
  5. Proactive Watch — 12 drift classes scanned every session start. Catches
...
Next steps:
  ...
  /mxm-help frameworks      The 64 frameworks you can dispatch
...
Current authoritative counts (post WS1+WS2, v1.2.0-alpha.2):
- 91 agents · 35 skill domains · 43 slash commands · 7 MCP servers · 47 MCP tools
- 14 hook scripts · 64 frameworks · 14 compliance frameworks · 16 ADRs · 12 drift classes
