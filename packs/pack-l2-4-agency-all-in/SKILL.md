---
name: L2.4 Agency All-In
description: "Maxim L2 pack. Bundles: All six L1 packs. Primary framework: Behavioral Moat Framing Doctrine (ADR-007)."
business_outcome: "See documents/ledgers/MOAT_TRACKER.md for the registered moat row; purchase to activate."
primary_framework: "Behavioral Moat Framing Doctrine (ADR-007)"
product_id: L2.4
pack_tier: L2
ships_with: v1.0.0
license: proprietary
...
Behavioral Moat Framing Doctrine (ADR-007) — applied across every output this pack produces. Framework mechanism named in the SKILL body below; anti-patterns registered in documents/ledgers/MOAT_TRACKER.md.
